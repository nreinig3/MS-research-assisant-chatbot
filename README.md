...
An intelligent RAG (Retrieval-Augmented Generation) chatbot that helps users learn more about MS treatment options and research advances, using a curated database of trusted studies and clinical trial data. Augmented with persistent user profiles and transparent citations.
...
- **Persistent user profiles** — remembers users across sessions for personalized research help
...
| 📚 **Curated Knowledge Base** | 150+ documents including clinical trials, guidelines, and research papers |
