...
An intelligent RAG (Retrieval-Augmented Generation) chatbot that helps users discover MS treatment options, clinical trials, and research advances using a curated database of trusted studies and clinical trial data. Augmented with persistent user profiles and transparent citations.
